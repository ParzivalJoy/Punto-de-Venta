...
export default function ImportarInv() {
    ...
    const importInf= () =>{
      ...
      Promise.all(vainilla).then(data=>{
        alert('Tu información se registró correctamente');
        ...
        <div className="row py-3">
            ...
            <div className="m-2 border">
              ...
              <div className="d-flex justify-content-center">
                   <img src={formato} className="img-fluid" alt="formato del excel" />
              </div>
            </div>
            <div className="m-2 border">
            ...
            <div className="py-2 m-2 border">
                ...
                <input type="file" accept=".xlsx" className="form-control" onChange={importExcel} />
            </div>
            <div className="py-2 m-3 border">
                <h6>3.Presiona el botón para mostrar la información en la tabla:</h6>
                <button className="btn btn-outline-dark" onClick={showProducts}>Cargar información en tabla</button>  
            </div>

            <div className="border">
               <h6>4.Presiona la casilla si lo que se importan son ingredientes y no productos que se venderán</h6>
            ...
            <div className="m-2 border">
              <h6>5.Si la información que quieres importar es correcta, presiona este botón para insertar la información:</h6>
              <button className="btn btn-outline-dark" disabled={registrarhab} onClick={importInf}>Registrar la información</button> 
            </div>
